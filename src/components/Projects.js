  ...
  return (
    ...
    <div class="text">
      ...
      <div className='proj'>
              ...
              <Card src={myWeb} title="Portfolio Website" description="The site you're on right now! Built with HTML, CSS, React, Framer Motion, and Chakra UI " urlCode="https://github.com/tyohare/polar-dev" urlDemo="https://tylerwebfolio.herokuapp.com/" hasDemo={true}/>
